...
class clique_simulator(): 
    def __init__(self,parameters,**kwargs): 
        ...
        self.observations = self.all_clique_feats[self.current_exp]
        ...
        self.T_nu_cone = parameters["betterFaster"]["T_nu_cone"]
        self.T_nu_tree = parameters["betterFaster"]["T_nu_tree"]
        self.feature_description_cache = {} 
        self.growth_state_relevancy_level =  
        '''
